...
let currencies = [
  ...
  },
  {
    ...
    abbreviation: "UZS",
    symbol: "\u00A3",
    flagURL: "http://www.geonames.org/flags/l/uz.gif",
  },
  {
    name: "Euro",
    abbreviation: "EUR",
...
currenciesList.addEventListener("focusout", currenciesListFocuesOut);

function currenciesListFocuesOut(event) {
  ...
  currenciesList.insertAdjacentHTML(
    ...
    `<li class="currency ${
      currency.abbreviation === baseCurrency ? "base-currency" : ""
          ...
          <div class="info">
            <p class="input">
              <span class="curency-symbol">${currency.symbol}</span
              ><input placeholder="0.0000" value=${inputValue}>
            </p>
